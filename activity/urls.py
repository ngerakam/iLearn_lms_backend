...
urlpatterns = [
    ...
    path('verify_started_course/<slug:course_slug>/', views.get_my_started_course),
    path('add-to-scoreboard/', views.create_score),
    path('course_track_started/<slug:course_slug>/', views.course_track_started),
    path('mark_course_as_done/<slug:course_slug>/', views.mark_course_done),
    path('track_started/<slug:course_slug>/<slug:lesson_slug>/', views.track_started),
    path('mark_as_done/<slug:course_slug>/<slug:lesson_slug>/', views.mark_done),
]
